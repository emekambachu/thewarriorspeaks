<template>
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <router-link
                    class="waves-effect"
                    exact
                    :to="{ name: 'AdminBlogCreate'}">
                    <button type="button" class="btn btn-primary waves-effect waves-light mb-2">Add post</button>
                </router-link>
        ...
        <laravel-vue-pagination v-if="searchActive"
                                ...
                                :limit="3"
                                :data="posts"
                                @pagination-change-page="searchPosts"
        >
            <template #prev-nav>
                <span>&lt; Previous</span>
            </template>
...
export default {
    ...
    methods: {
        getPosts(page = 1){
            ...
            axios.get('/api/admin/blog/posts?page=' + page)
                .then((response) => {
        ...
        searchPosts(page = 1){
            ...
            this.dataLoaded = false;
            axios.post('/api/admin/blog/posts/search?page=' + page, this.form)
                .then((response) => {
